    ...
    <section>
      <div class="container">
        <div class="row">
          <div class="col-md-8">
            <div class="profile">
              <h1 class="page-header">Sree Lal</h1>
              <div class="row">
                <div class="col-md-4">
                  <img src="img/user1.png" class="img-thumbnail" alt="">
                </div>
                <div class="col-md-8">
                  <ul>
                    <li><strong>Name:</strong>basil lal</li>
                    <li><strong>Email:</strong>baslal@gmail.com</li>
