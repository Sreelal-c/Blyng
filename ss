                          ...
                          <div class="col-md-11">
                              <div class="media">
                                <div class="media-left">
                                  <a href="#">
                                    <img class="media-object photo-profile" src="img/user.png" width="40" height="40" alt="...">
                                  </a>
                                </div>
                                <div class="media-body">
                                  <a href="#" class="anchor-username"><h4 class="media-heading">Sreelal C</h4></a> 
                     ...
                     <div class="post-footer-comment-wrapper">
                         ...
                         <div class="comment">
                              <div class="media">
                                <div class="media-left">
                                  <a href="#">
                                    <img class="media-object photo-profile" src="img/user.png" width="32" height="32" alt="...">
                                  </a>
                                </div>
                                <div class="media-body">
                                    <div class="detailBox">
